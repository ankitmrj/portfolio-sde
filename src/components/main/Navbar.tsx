        ...
        <div className="relative border-x border-border min-[880px]:border-x-0 px-6 py-3.5 flex items-center justify-between">
            ...
            >
              {navItems.map((item, idx) => (
                <Link
                  ...
                  className={`relative px-3 py-1.5 font-mono text-[11px] font-medium uppercase tracking-[0.15em] transition-colors duration-200 ${hoveredIndex === idx
                      ? "text-foreground"
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <kbd className="px-1.5 py-0.5 border border-border/60 rounded bg-muted/50 font-sans text-[8px] opacity-75">
                Ctrl K
              </kbd>
            </button>
            ...
            {/* GitHub */}
            <a
              href="https://github.com/ankitmrj"
              target="_blank"
          ...
          >
            ...
            {mounted && (
              <div className="flex flex-col gap-1.5">
                <span className="text-[9px] uppercase tracking-wider text-muted-foreground/60 font-bold font-mono">
                  Language
                </span>
