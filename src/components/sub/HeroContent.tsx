...
const HeroContent: FC = () => {
  ...
  const handleConnectClick = () => {
    ...
    if (contactSection) {
      smoothScrollTo(contactSection, 1200)
    }
  }
  ...
  return (
    ...
    >
      ...
      >
        <Badge
          variant="secondary"
          className="bg-red-500 text-white dark:bg-red-500 font-extrabold"
        >
          <TbDeviceLaptop />
          The Developer
        </Badge>
      ...
      >
        ...
        <PointerHighlight rectangleClassName="rounded-none">
          <span className="text-primary p-3 text-3xl lg:text-6xl">
            Software Engineer
          </span>
        </PointerHighlight>

        <span className="text-base text-muted-foreground italic max-w-[600px] mx-auto">
